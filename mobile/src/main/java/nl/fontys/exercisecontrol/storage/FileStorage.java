package nl.fontys.exercisecontrol.storage;
...
public class FileStorage
{
     ...
     * @throws java.io.IOException when loading or deserializing failed.
     */
    public <T> T load(String identifier)
            throws IOException
    {
     ...
     * @param <T>type    of object
     * @throws java.io.IOException when serializing or saving failed.
     */
    public <T> void save(String identifier,
                         T obj)
            throws IOException
    {
        ...
        try
        {
            fos = context.openFileOutput(identifier,
